<%@ Page Title="" Language="C#" MasterPageFile="~/backend.master" AutoEventWireup="true" CodeFile="GradeStudentsInCourse.aspx.cs" Inherits="CL_GradeStudentsInCourse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <nav class="breadcrumb">
           ...
           <span class="c-gray en">&gt;</span> 导出年级选课表 
           ...
           <div class="cl pd-5 bg-1 bk-gray mt-20"> 
                    <span class="l">
                         <a href="javascript:;" class="btn btn-secondary radius">
                              <i class="Hui-iconfont">&#xe644;</i><span>&nbsp;导出年级选课表</span> 
                         </a> 
                    </span>
             </div>
    ...
    <script src="../assets/js/CL/gradeStudentsInCourse.js"></script>
